...
async function serve(cmd) {
  ...
  const distStat = await fs.promises.stat(options.generate.dir).catch((err) => null);
  ...
  app.use(options.router.base, serveStatic__default["default"](options.generate.dir, {
    extensions: ["html"]
  }));
