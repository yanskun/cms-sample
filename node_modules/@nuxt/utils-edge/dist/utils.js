/*!
 * @nuxt/utils-edge v2.16.0-27260655.293dc11a (c) 2016-2021
...
function createLockPath({ id = "nuxt-edge", dir, root }) {
  ...
  if (!lockPaths.size) {
    onExit__default["default"](() => {
      for (const lockPath2 of lockPaths) {
        fs__default["default"].removeSync(lockPath2);
      }
    });
  }
...
const guardDir = function guardDir2(options, key1, key2) {
  ...
  if (dir1 && dir2 && (dir1 === dir2 || dir1.startsWith(dir2) && !path__default["default"].basename(dir1).startsWith(path__default["default"].basename(dir2)))) {
...
function serializeFunction(func) {
  ...
  return serialize__default["default"](func).replace(serializeFunction.assignmentRE, (_, spaces) => {
